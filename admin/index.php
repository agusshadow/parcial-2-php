...
$vista = isset($_GET['s']) ? $_GET['s'] : 'inicio-admin';
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container">
              <a class="navbar-brand logo" href="index.php?s=inicio-admin"><h1 class="m-0">logo</h1></a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link" href="index.php?s=inicio-admin">Inicio</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="index.php?s=panel-productos-admin">Panel de control</a>
                  </li>
                </ul>
                <form class="d-flex">
    ...
    <main class="pt-5 mt-4">
        ...
        ?>
        <p class="mensaje-exito text-white p-4"><?= $mensaje_exito?></p>
        <?php
        endif;
        ?>
        ...
        if ($mensaje_error !== null):
            ?>
            <p class="mensaje-error text-white p-4"><?= $mensaje_error?></p>
        <?php
        endif;
        ?>
        </section>
